const ForgotUsernameErrorIcon = ({ size=17,className="",...props }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <g clipPath="url(#clip_forgot_error)">
        <path
...
export default ForgotUsernameErrorIcon;